...
public class FareCalculatorServiceTest {
    ...
    public void calculateFareCarWithLessThanOneHourParkingTime(){
        ...
        double expectedPrice = fareCalculatorService.roundParkingFare(0.75 * Fare.CAR_RATE_PER_HOUR);
    ...
    public void calculateFareCarWithMoreThanADayParkingTime(){
        ...
        double expectedPrice = fareCalculatorService.roundParkingFare(24 * 0.95 * Fare.CAR_RATE_PER_HOUR);
        
        ticket.setInTime(inTime);
        ticket.setOutTime(outTime);
        ticket.setParkingSpot(parkingSpot);
        ticket.setRegisteredVehicle(true);
        fareCalculatorService.calculateFare(ticket);
        assertEquals(expectedPrice , ticket.getPrice());
    }
    ...
    public void calculateFareWithDefaultReturnsIllegalArgumentException(){
        ...
        inTime.setTime( System.currentTimeMillis() - (  24 * 60 * 60 * 1000) );//24 hours parking time should give 24 * parking fare per hour
        Date outTime = new Date();
        ParkingSpot parkingSpot = new ParkingSpot(1, ParkingType.UNKNOWN_TYPE,false);
